...
<section class="product" id="product">
    ...
    <div class="product-card">
      <img src="../asset/images/product/modem.png" alt="Modem">
      <h3>MODEM</h3>
      <p>Rp. 400.000</p>
    </div>
    <div class="product-card">
      <img src="../asset/images/product/router.png" alt="Router">
      <h3>ROUTER</h3>
      <p>Rp. 600.000</p>
    </div>
    <div class="product-card">
      <img src="../asset/images/product/smart-cam.png" alt="Smart Cam">
      <h3>SMART CAM</h3>
      <p>Rp. 500.000</p>
    </div>
    <div class="product-card">
      <img src="../asset/images/product/usb-to-lan.png" alt="USB to LAN">
      <h3>USB TO LAN</h3>
      <p>Rp. 350.000</p>
    </div>
    <div class="product-card">
      <img src="../asset/images/product/switch.png" alt="Switch">
      <h3>SWITCH</h3>
      <p>Rp. 750.000</p>
    </div>
    <div class="product-card">
      <img src="../asset/images/product/kabel-lan.png" alt="Kabel LAN">
      <h3>KABEL LAN</h3>
      <p>Rp. 100.000</p>
    </div>
  </div>
